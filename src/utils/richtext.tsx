...
export const defaultPortableRichTextResolvers: PortableTextReactResolvers = {
  ...
  block: {
    h1: ({ children }) => <h1 className="text-8xl font-serif text-primary">{children}</h1>,
    h2: ({ children }) => <h2 className="text-6xl font-serif text-primary">{children}</h2>,
    h3: ({ children }) => <h3 className="text-4xl font-serif text-primary">{children}</h3>,
