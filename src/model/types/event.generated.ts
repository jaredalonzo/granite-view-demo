 ...
 */
export type EventTypeCodename = keyof Pick<
 ...
 */
export function isEventTypeCodename(
	value: string | undefined | null,
): value is EventTypeCodename {
	return (
		typeof value === "string" && value === ("event" satisfies EventTypeCodename)
	);
}
